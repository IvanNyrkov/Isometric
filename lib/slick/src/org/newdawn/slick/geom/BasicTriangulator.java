...
public class BasicTriangulator implements Triangulator {
	 ...
	 * the points A,B,C
	 * 
	 * @param Ax IsoPoint A x-coordinate
	 * @param Ay IsoPoint A y-coordinate
	 * @param Bx IsoPoint B x-coordinate
	 * @param By IsoPoint B y-coordinate
	 * @param Cx IsoPoint C x-coordinate
	 * @param Cy IsoPoint C y-coordinate
	 * @param Px IsoPoint P x-coordinate
	 * @param Py IsoPoint P y-coordinate
	...
	/**
	 * A list of type <code>IsoPoint</code>
	 * 
	 * @author Kevin Glass
	 */

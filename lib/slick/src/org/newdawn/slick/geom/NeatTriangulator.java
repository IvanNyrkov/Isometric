...
public class NeatTriangulator implements Triangulator
{
	 ...
	 * the points A,B,C
	 * 
	 * @param f IsoPoint A x-coordinate
	 * @param f1 IsoPoint A y-coordinate
	 * @param f2 IsoPoint B x-coordinate
	 * @param f3 IsoPoint B y-coordinate
	 * @param f4 IsoPoint C x-coordinate
	 * @param f5 IsoPoint C y-coordinate
	 * @param f6 IsoPoint P x-coordinate
	 * @param f7 IsoPoint P y-coordinate
